    ...
    $meta_boxes['logs-patterns-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_logs_patterns_settings_fields', array(
            ...
            'points_awarded_log_pattern' => array(
                ...
                'description' => __( 'Used when an admin awards an user with points. Available tags:', 'gamipress' ) . gamipress_get_log_pattern_tags_html( array( '{admin}', '{user}', '{points}', '{points_type}', '{total_points}', '{site_title}' ) ),
                'type' => 'text',
            ...
            'points_revoked_log_pattern' => array(
                ...
                'description' => __( 'Used when an admin revokes points of an user. Available tags:', 'gamipress' ) . gamipress_get_log_pattern_tags_html( array( '{admin}', '{user}', '{points}', '{points_type}', '{total_points}', '{site_title}' ) ),
                'type' => 'text',
            ...
            'achievement_awarded_log_pattern' => array(
                ...
                'description' => __( 'Used when an admin awards an user with an achievement. Available tags:', 'gamipress' ) . gamipress_get_log_pattern_tags_html( array( '{admin}', '{user}', '{achievement}', '{achievement_type}', '{site_title}' ) ),
                'type' => 'text',
            ...
            'rank_awarded_log_pattern' => array(
                ...
                'description' => __( 'Used when an admin ranks an user to a new rank. Available tags:', 'gamipress' ) . gamipress_get_log_pattern_tags_html( array( '{admin}', '{user}', '{rank}', '{rank_type}', '{site_title}' ) ),
                'type' => 'text',
